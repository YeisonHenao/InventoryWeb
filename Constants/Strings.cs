namespace InventarioProyecto.Constants;
...
{
    public const string OperationSuccess = "Operación realizada con éxito.";
    public const string OperationFailed = "La operación ha fallado.";
    public const string NotFound = "No encontrado.";
    public const string SomethingWentWrong = "Algo salió mal. Por favor, inténtalo de nuevo.";
}